				...
				slimScroll: function(options) {
					...
					this.each(
						function() {
							...
							o.height = (
									   o.height == 'auto'
									   ) ? me.parent().innerHeight() : o.height;

							// wrap content
							var wrapper = $(divS).addClass(o.wrapperClass).css(
								{
									position: 'relative', overflow: 'hidden', width: o.width, height: o.height
								}
							);
							...
							me.css(
								{
									overflow: 'hidden', width: o.width, height: o.height
								}
							);
							...
							var posCss = (
										 o.position == 'right'
										 ) ? {right: o.distance} : {left: o.distance};
							rail.css(posCss);
							bar.css(posCss);
							...
							function scrollContent(y, isWheel, isJump) {
								...
								if (isWheel) {
									...
									delta = (
											y > 0
											) ? Math.ceil(delta) : Math.floor(delta);
								...
								delta = percentScroll * (
								me[0].scrollHeight - me.outerHeight()
								);
