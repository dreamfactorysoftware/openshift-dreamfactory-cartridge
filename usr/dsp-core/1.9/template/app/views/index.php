...
foreach ( $models as $_model )
{
    ...
    {
        $_email =
            '<a title="Click to view this user in Drupal" target="_blank" href="https://www.dreamfactory.com/user/' .
            $_model['drupal_id'] .
            '">' .
    ...
    $_html .=
        '<td><a title="Click to browse this URL" target="_blank" href="http://' .
...
jQuery(
    function ($) {
         ...
         */
        $_table.on(
            'mouseenter mouseleave', 'tbody tr td:first-child', function (e) {
